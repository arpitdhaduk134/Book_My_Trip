              ...
              if($query->rowCount() > 0)
              {
                ...
                { 
                  ...
                  <tr align="center">
                    ...
                    <td><a href="package_details.php?pkgid=<?php echo htmlentities($result->pkgid);?>"><?php echo htmlentities($result->packagename);?></a></td>
                    ...
                    <?php }?>                    
                    <td><a href="invoice.php?bkid=<?php echo htmlentities($result->bookid);?>" class="view">Invoice</a>
</td>
