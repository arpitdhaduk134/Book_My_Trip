              ...
              <div class="card">
                ...
                <div class="modal fade" id="delete">
                  <div class="modal-dialog modal-xl ">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title">Deleted admin</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      ...
                      ?>
                          <tr>
                            ...
                            <td class=" text-center">
                              ...
                              <a href="user_register.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');" title="Delete this User" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                          </tr>
                      <?php $cnt = $cnt + 1;
                        }
