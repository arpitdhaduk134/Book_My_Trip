            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form autocomplete="off" role="form" id="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group mb-3">
                      <input type="text" class="form-control form-control-lg" name="username" id="exampleInputEmail1" placeholder="Username" autocomplete="off" required>
                    </div>
                    ...
                    <hr>
                    <a href="../index.php" target="_self" class="btn btn-facebook btn-block">
                      Back To Home
                    </a>
                  </form>
                </div>
