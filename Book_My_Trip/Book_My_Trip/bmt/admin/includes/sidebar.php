<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    <a class="nav-link" href="manage_issues.php">
      <i class="fas fa-fw fa-chart-area"></i>
      <span>Enquiry</span>
    </a>
  </li>
   ...
   <li class="nav-item">
    ...
    <div id="users" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="user_register.php">Register Admin</a>
        <a class="collapse-item" href="Permissions.php">Admin Permissions</a>
      </div>
    </div>
  </li>
</ul>