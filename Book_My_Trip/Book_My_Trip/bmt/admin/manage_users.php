                      ...
                      if($query->rowCount() > 0)
                      {
                        ...
                        {       
                          ...
                          <tr>
                            ...
                            <td><a href="manage_users.php?uid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Delete ?');" title="Delete this User" class="btn btn-sm btn-danger">Delete</a> </td>
                          </tr>
                          </tr>
                          <?php $cnt=$cnt+1;
                        } 
