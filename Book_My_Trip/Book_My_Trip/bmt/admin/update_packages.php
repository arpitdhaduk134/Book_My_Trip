...
if (isset($_POST['submit'])) {
  ...
  $sql = "update TblTourPackages set PackageName=:pname,HotelName=:hname,PackageLocation=:plocation,PackagePrice=:pprice,Bus=:bprice,Train=:tprice,Flight=:fprice,PackageFetures=:pfeatures,PackageDetails=:pdetails where PackageId=:pid";
                  ...
                  ?>
                      <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="hotelname" id="hotelname" placeholder=" Package Type eg- Family Package / Couple Package" value="<?php echo htmlentities($result->HotelName); ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="packageprice" id="packageprice" placeholder=" Package Price is INR" value="<?php echo htmlentities($result->PackagePrice); ?>" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="focusedinput" class="col-sm-2 control-label">Bus Ticket Price</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="bprice" id="bprice" placeholder=" Package Price is INR" value="<?php echo htmlentities($result->Bus); ?>" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="focusedinput" class="col-sm-2 control-label">Train Ticket Price</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="tprice" id="tprice" placeholder=" Package Price is INR" value="<?php echo htmlentities($result->Train); ?>" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="focusedinput" class="col-sm-2 control-label">Flight Ticket Price</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" name="fprice" id="fprice" placeholder=" Package Price is INR" value="<?php echo htmlentities($result->Flight); ?>" required>
                          </div>
                        </div>

                        <div class="form-group">
                          <label for="focusedinput" class="col-sm-2 control-label">Meal</label>
                          <div class="col-sm-8">
